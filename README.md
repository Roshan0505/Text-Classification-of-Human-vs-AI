...
*Project Overview*
AI vs Human Text Classification: A Machine Learning project that detects whether a given piece of text is AI-generated or Human-written.
...
1. *Data Preprocessing*: Text cleaning, lowercase conversion, special character removal, and stopword removal
2. *Train-Test Split*: 80% training, 20% testing with stratified split
3. *Feature Engineering*: TF-IDF vectorization with max_features = 20000
4. *Model Selection*: Logistic Regression with max_iter = 1000
5. *Model Performance*: ~86.7% accuracy
...
# Author
Roshan, Undergraduate Student – AIML, passionate about Machine Learning and AI Systems 😊
